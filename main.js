...
function calculateMinMax(minOrMax, numArr){
...
function calculator() {
    console.log('Absolute value of -45.67 is ' + absVal(-45.67));
    console.log('5 to the power of 3 is ' + calculatePower(5,3));
    console.log('The square root of 144 is ' + calculateSquareRoot(144));
    let nArr = [3, 78, -12, 0.5, 27];
    console.log(`The min of ${nArr} is ${calculateMinMax('MIN', nArr)}`);
    console.log(`The max of ${nArr} is ${calculateMinMax('max', nArr)}`);
    console.log('A random number between 1 and 50 is ' + generateRandomNumber(50));
    console.log('Rounded 23.67891 to 2 decimals is ' + customRounding(23.67891, 2));
}
...
// misunderstood instructions code I accidentally did on my own before class:
